            ...
            <form id="payment-form" > 
                <div class="container paymentInfo">
                    ...
                    <div class="row paymentRow">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="cardNumber" maxlength="16" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                    ...
                    <div class="row paymentRow">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="cvc" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                    <div class="row paymentRow">
                ...
                <div class="container billingInfo">
                    ...
                    <div class="row input-row">
                        ...
                        <div class="col-md-2">
                            <input type="text" maxlength="2" name="billingState"/>
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="billingZip" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
