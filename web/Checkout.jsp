            ...
            <form id="checkout-form">
                <div class="container contactInfo">
                    ...
                    <div class="row input-row">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="phone" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                ...
                <div class="container shippingInfo">
                    ...
                    <div class="row input-row">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="zip" maxlength="5" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
